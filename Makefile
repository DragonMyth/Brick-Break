...
OFILES = brickbreaker.o myLib.o BrickBreakerStart.o gameoverScene.o level1.o playerBoard.o ball.o logic.o font.o text.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h BrickBreakerStart.h gameoverScene level1.h playerBoard.h ball.h
